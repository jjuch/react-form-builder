...
function (_React$Component19) {
  ...
  function FileUpload(props) {
    ...
    _defineProperty(_assertThisInitialized(_this14), "displayFile", function (e) {
      ...
      if (target.files && target.files.length) {
        file = target.files[0];
        console.log(file); // eslint-disable-next-line no-undef
  ...
  _createClass(FileUpload, [{
    ...
    value: function render() {
      var baseClasses = 'SortableItem rfb-item';
      var name = this.props.data.field_name;
      var fileInputStyle = this.state.file ? {
        display: 'none'
      } : null;
      ...
      }), " Upload File"), _react["default"].createElement("p", null, "Select an file from your computer or device."))), this.state.file && _react["default"].createElement("div", null, _react["default"].createElement("a", {
        href: sourceDataURL
      }, this.state.file), _react["default"].createElement("div", {
        className: "btn btn-school btn-image-clear",
        onClick: this.clearImage
