  ...
  _createClass(Download, [{
    ...
    value: function render() {
      ...
      return _react["default"].createElement("div", {
        ...
        href: this.props.data.file_path
      }, this.props.data.content)));
    }
  }]);
...
function (_React$Component19) {
  ...
  function FileUpload(props) {
    ...
    _this14 = _possibleConstructorReturn(this, _getPrototypeOf(FileUpload).call(this, props));

    _defineProperty(_assertThisInitialized(_this14), "displayFile", function (e) {
      ...
      if (target.files && target.files.length) {
        file = target.files[0];
        console.log(window.URL.createObjectURL(file)); // eslint-disable-next-line no-undef
    ...
    _defineProperty(_assertThisInitialized(_this14), "clearFile", function () {
      _this14.setState({
        file: null,
        link: null
      });
  ...
  _createClass(FileUpload, [{
    ...
    value: function render() {
      var baseClasses = 'SortableItem rfb-item';
      var name = this.props.data.field_name;
      var fileInputStyle = this.state.link ? {
        display: 'none'
      } : null;
      ...
      if (this.props.read_only === true && this.props.defaultValue && this.props.defaultValue.length > 0) {
        if (this.props.defaultValue.indexOf(name > -1)) {
          ...
          sourceDataURL = "data:application/pdf;base64,".concat(this.props.defaultValue);
        }
      }
      ...
      return _react["default"].createElement("div", {
        ...
        href: sourceDataURL
      }, this.state.file) : _react["default"].createElement("div", {
        className: "image-upload-container"
      }, _react["default"].createElement("div", {
        style: fileInputStyle
      }, _react["default"].createElement("input", {
      ...
      }), " Upload File"), _react["default"].createElement("p", null, "Select a file from your computer or device."))), this.state.file && _react["default"].createElement("div", null, _react["default"].createElement("a", {
...
function (_React$Component20) {
  ...
  function Range(props) {
    ...
    _this15 = _possibleConstructorReturn(this, _getPrototypeOf(Range).call(this, props));

    _defineProperty(_assertThisInitialized(_this15), "changeValue", function (e) {
      var target = e.target;
    ...
    _this15.inputField = _react["default"].createRef();
    _this15.state = {
